...
const Entradamedicamentos = () => {
     const [datos, setDatos] = useState([]);
        ...
        const API = "http://localhost/backendmedicamentos/api/medicamentos/getEntradaMedicamentos.php";
  ...
  return (
    ...
    <Toast ref={toast} />
    <h2 className="text-center">Listado de Medicamentos Recepcionados</h2>
    <h3 className="text-center py-1"> ({datos.length}) Medicamentos Recepcionados en el Sistema </h3>
   ...
   <DataTable value={datos} paginator rows={10} rowsPerPageOptions={[5, 10, 25, 50]} globalFilter={globalFilterValue}>
        <Column field="medicamento_codigo" header="Código" sortable style={{ textAlign: 'center' }} />
        ...
        <Column field="cantidad_recibida" header="Cantidad Recibida" sortable style={{ textAlign: 'center' }} />
        <Column field="lote" header="Lote" sortable style={{ textAlign: 'center' }} />
        <Column field="fecha_vencimiento" header="Fecha de Vencimiento" sortable style={{ textAlign: 'center' }} />
        <Column field="proveedor_nombre" header="Nombre del Proveedor" sortable style={{ textAlign: 'center' }} />
        <Column field="proveedor_cedula" header="Cedula del Proveedor" sortable style={{ textAlign: 'center' }} />
        <Column field="usuario_id" header="Usuario" sortable style={{ textAlign: 'center' }} />
        <Column field="fecha_entrada" header="Fecha de Recepción" sortable style={{ textAlign: 'center' }} />
